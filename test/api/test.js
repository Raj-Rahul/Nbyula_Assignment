...
describe('Unit tests for CRUD operations on different end points', () => {
  ...
  it('OK, cannot create a new Quiz without authorization', (done)=> {
    ...
    .send({"name":"My Quiz","instructions":"Instructions goes here","isEnabled":true,"questions":[{"question":"What is the name of your univercity","answers":[{"option":"LPU"},{"option":"BITS"},{"option":"AMITY"},{"option":"CU"}],"answer":1,"isEnabled":true,"explanation":"Something"},{"question":"What is capital of india","answers":[{"option":"mumbai"},{"option":"kolkata"},{"option":"delhi"},{"option":"jalandhar"}],"answer":3,"isEnabled":true,"explanation":"Something"}],"duration":{"hours":10,"minutes":20,"seconds":30}})
    .then((res) => {
  ...
  it('OK, Added a new question', (done)=> {
    ...
    .set('Authorization', 'Basic YWRtaW46cGFzc3dvcmQ=')
    .send({"question":"What is capital of india","answers":[{"option":"LPU"},{"option":"BITS"},{"option":"AMITY"},{"option":"CU"}],"answer":1,"isEnabled":true,"explanation":"Something"})
    .then((res) => {
